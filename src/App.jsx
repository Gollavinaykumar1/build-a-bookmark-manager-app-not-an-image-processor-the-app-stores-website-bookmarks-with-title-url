    ...
    <div className="min-h-screen" style={{ backgroundColor: "#fdf2f8" }}>
      ...
      <nav className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center gap-3">
          ...
          <span className="font-bold text-gray-900 text-lg">Build A Bookmark Manager App Not An Image</span>
        </div>
      </nav>
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900">Build A Bookmark Manager App Not An Image</h1>
        ...
        >
          ...
          <p className="text-gray-600 font-medium">Drop an image here or <span style={{ color: "#ec4899" }}>browse</span></p>
